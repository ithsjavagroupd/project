...
//import com.example.springbootproject.exceptions.GlobalControllerAdvice;
...
//@ContextConfiguration(classes = {SecurityConfig.class, ChainController.class, GlobalControllerAdvice.class})
